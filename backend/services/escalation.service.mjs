...
EscalationModel.hasMany(EscalationConversationsModel, {
  foreignKey: "escalationId",
  as: "conversations",
});

EscalationConversationsModel.belongsTo(EscalationModel, {
  foreignKey: "escalationId",
  as: "escalation",
});
  ...
  async conversation_read(params) {
    try {
      ...
      if (id) {
        ...
        totalCount = await this.conversation_repository.countDocuments(whereClause);
